...
while True :
    if health[0] >= 1:
        ...
        if dice >= 10:
            print("𝖄𝖔𝖚 𝖉𝖊𝖆𝖑𝖑𝖊𝖉", strenght[0]/2)
            # noinspection PyTypeChecker
            gooblins[0] = gooblins[0]- strenght[0]/2
            if gooblins[0] - strenght[0] == 0:
                print("𝕮𝖔𝖓𝖌𝖗𝖆𝖙𝖘 𝖞𝖔𝖚 𝖐𝖎𝖑𝖑𝖊𝖉 𝖙𝖍𝖊𝖒")
            elif gooblins[0] == 10:
                print("𝕲𝖔𝖔𝖇𝖑𝖎𝖓'𝖘 𝖙𝖚𝖗𝖓")
                sleep(1)
                print("𝕲𝖔𝖔𝖇𝖑𝖎𝖓 𝖉𝖊𝖆𝖑𝖊𝖉", randint(1, gooblins[1]))
                print("𝖄𝖔𝖚'𝖗𝖊", gooblins[1] - health[0] ,"ℋ𝒫")
    ...
    sleep(1)
    print(fairy)
    fairybite = health[0]-(randint (1,5))
    break
while health[0] > 0 and  fairy[0] > 0:
        ...
        if choise == "yes":
                    ...
                    sleep(1)
                    print ("𝕿𝖍𝖊 𝖉𝖎𝖈𝖊 𝖗𝖔𝖑𝖑𝖊𝖉🎲", dice)
                    fairy[0] = fairy[0] - strenght[0]
                    if dice >= 15 and fairy[0] <= 0 :
                        print("🎊𝓨𝓞𝓤 𝓦𝓞𝓝𝓝!!🎉")
                        break
                    else:
                        # noinspection PyTypeChecker
                        fairy[0] = fairy[0] - strenght[0]/2
                        print("𝖕𝖑𝖆𝖞𝖊𝖗 𝖉𝖊𝖆𝖑𝖑𝖊𝖉", strenght[0])
...
#força do player é 1, força da fada é 1, vida dos dois é 0
        ...
        if fairy[0] >= 1:
            print("𝕱𝖆𝖎𝖗𝖞 𝖆𝖙𝖙𝖆𝖈𝖐𝖊𝖉 𝖞𝖔𝖚 𝖆𝖓𝖉 𝖉𝖊𝖆𝖑𝖑𝖊𝖉🧚🏼‍♂️", fairy[1] - health[0])
            health[0] = health[0] - fairy[1]
        elif fairy[1] - health[0] >= 0:
            print("𝖄𝖔𝖚 𝖑𝖔𝖔𝖘𝖊...")
